...
(function () {
  ...
  var PAGE = {
    en: {
      ...
      'about.lede': 'P6 is urban living in Ružinov, where the Miletička neighbourhood meets the new downtown. It brings 44 apartments, green balconies and a roof terrace for all residents.',
    ...
    de: {
      ...
      'about.lede': 'P6 ist städtisches Wohnen in Ružinov, an der Schnittstelle zwischen dem Miletička-Viertel und der neuen Downtown. Es bringt 44 Wohnungen, begrünte Balkone und eine Dachterrasse für alle Bewohner.',
    ...
    uk: {
      ...
      'about.lede': 'Проєкт P6 пропонує міське житло в Ружинові, на межі кварталу Мілетічка та нового Downtown: 44 квартири, зелені балкони та тераса на даху для всіх мешканців.',
